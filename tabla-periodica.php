    ...
    <section
        ...
        <div class="w-full md:w-5/12">
            <div class="relative group">
                ...
                <img loading="lazy" src="img/laboratorios/labo-tabla-periodica.jpg" alt="Laboratorio de análisis"
        ...
        <div class="w-full md:w-7/12 flex flex-col justify-center">
            ...
            <p class="text-slate-600 text-base md:text-2xl leading-relaxed mb-8 border-l-4 border-blue-500 pl-3">
                La tabla periódica fue diseñada por el químico ruso Dmitri Mendeléiev en 1869 y contenía 63 de los
                118 elementos conocidos hoy en la naturaleza. Es un cuadro que presenta todos los elementos químicos
                que existen ordenados según sus propiedades físicas.
            </p>
        </div>
    </section>
            ...
            <div class="periodic min-w-[1200px] px-4">
                    ...
                    <div class="cell">
                        <div class="element">
                            ...
                            <div class="at_details">
                                Talio<br />[Xe]4f<sup>14</sup>5d<sup>10</sup>6s<sup>2</sup>6p<sup>1</sup></div>
                        </div>
                    </div>
                    <div class="cell">
                        <div class="element">
                            ...
                            <div class="at_details">
                                Plomo<br />[Xe]4f<sup>14</sup>5d<sup>10</sup>6s<sup>2</sup>6p<sup>2</sup></div>
                        </div>
                    </div>
                    <div class="cell">
                        <div class="element">
                            ...
                            <div class="at_details">
                                Bismuto<br />[Xe]4f<sup>14</sup>5d<sup>10</sup>6s<sup>2</sup>6p<sup>3</sup></div>
                        </div>
                    </div>
                    <div class="cell">
                        <div class="element">
                            ...
                            <div class="at_details">
                                Polonio<br />[Xe]4f<sup>14</sup>5d<sup>10</sup>6s<sup>2</sup>6p<sup>4</sup></div>
                        </div>
                    </div>
                    <div class="cell">
                        <div class="element">
                            ...
                            <div class="at_details">
                                Astato<br />[Xe]4f<sup>14</sup>5d<sup>10</sup>6s<sup>2</sup>6p<sup>5</sup></div>
                        </div>
                    </div>
                    <div class="cell">
                        <div class="element">
                            ...
                            <div class="at_details">
                                Radón<br />[Xe]4f<sup>14</sup>5d<sup>10</sup>6s<sup>2</sup>6p<sup>6</sup></div>
                        </div>
                    </div>
                </div>
                <div class="periodic-row">
                    ...
                    <div class="cell">
                        <div class="element">
                            ...
                            <div class="symbol">Rf</div>
                            <div class="at_details">Rutherfordio<br />[Rn]5f<sup>14</sup>6d<sup>2</sup>7s<sup>2</sup>
                            </div>
                        </div>
                    </div>
                    <div class="cell">
                ...
                <div class="periodic-row">
                    ...
                    <div class="cell">
                        <div class="element">
                            ...
                            <div class="at_details">Protactinio<br />[Rn]5f<sup>2</sup>6d<sup>1</sup>7s<sup>2</sup>
                            </div>
                        </div>
                    </div>
                    <div class="cell">
                ...
                <div class="legend">
                    ...
                    <ul class="list-3">
                        ...
                        <li class="type-12"><img
                                src="https://pixabay.com/static/uploads/photo/2014/04/02/10/26/nuclear-303831_960_720.png"
                                width="13"> masa de elementos radiactivos entre paréntesis</li>
                    </ul>
                </div>
